...
namespace geantgram\translatemanager\models;
...
class LanguageTranslate extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['id'], 'integer'],
            [['id'], 'exist', 'targetClass' => '\geantgram\translatemanager\models\LanguageSource'],
            [['language'], 'exist', 'targetClass' => '\geantgram\translatemanager\models\Language', 'targetAttribute' => 'language_id'],
            [['translation'], 'string'],
